...
public class ArvoreBinaria {
	...
	public boolean pesquisarInterativo(int chave){

		No aux=raiz;
		while( aux != null && aux.elemento!=chave){
	...
	public int numeroImpares(     ){
		...
		return contaImpar (raiz);

	}


	private  int contaImpar ( No raiz)
	{
		...
		count  = count+ contaImpar(raiz.esq);
		count  = count+contaImpar( raiz.dir);
   ...
   public boolean hasDiv11(No i){
	...
	public int calculaSomaNegativos() {
		int resultado = calculaNegativos(raiz, 0);
		System.out.println("RESULTADO: "+resultado);
		return  resultado;
	}

	public int calculaNegativos(No i, int resultado) {
		if (i != null) {
			if (i.elemento < 0) {
				System.out.println("entrou if");
				resultado += i.elemento;
			}
			calculaNegativos(i.esq, resultado);
			calculaNegativos(i.dir, resultado);
		}
